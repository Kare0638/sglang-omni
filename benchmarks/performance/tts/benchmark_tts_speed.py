...
def _compute_token_metrics(successes: list[RequestFuncOutput]) -> dict:
...
def _build_requests(
    ...
    return [
        RequestFuncInput(
            ...
            api_url=api_url,
            model=args.model,
            ref_audio=None if args.no_ref_audio else sample.get("ref_audio"),
            ref_text=None if args.no_ref_audio else sample.get("ref_text"),
